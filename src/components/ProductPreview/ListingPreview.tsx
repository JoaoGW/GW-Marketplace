    ...
    <View w="47%" maxHeight={230} mb={25}>
      <View>
        <Image
          ...
          borderRadius={7}
        />
        <View position='absolute' top={0} left={0} right={0} p={5} flexDirection='row' justifyContent='space-between'>
      ...
      <View mt={2}>
        ...
        <Text fontSize="$sm" fontWeight="$bold" style={{ lineHeight: 20, marginBottom: 0 }}>
          R$
          <Text fontWeight="$bold" fontSize="$lg" style={{ lineHeight: 20 }}> 59,90</Text>
        </Text>
      </View>
    </View>
  )
